...
> Make sure you've read the notes [here](/blob/main/notes/Interfaces.md)

1.	Open and run the program [tut08_01](/blob/main/code/tutorials/tut08_01/tut08_01.zip?raw=true). Take a moment to examine all the code and the output.
...
3.	Open and run the program [tut08_02](/blob/main/code/tutorials/tut08_02/tut08_02.zip?raw=true). Take a moment to examine all the code and the output.
...
4.	Many other Java classes implement the ``Comparable`` interface like wrapper classes ``Integer``, ``Double``, ``Character``, etc.  
	...
	Open the program [tut08_03](/blob/main/code/tutorials/tut08_03/tut08_03.zip?raw=true). 
...
1.	Open and run the program [tut08_04](/blob/main/code/tutorials/tut08_04/tut08_04.zip?raw=true). 
...
4.	Provide the required changes to sort the circles by radius values.  You'll need to:
	...
	You should refer to the notes [here](/blob/main/notes/Interfaces.md)
...
1.	Open the program [tut08_05](/blob/main/code/tutorials/tut08_05/tut08_05.zip?raw=true). 
...
1.	Open the program [tut08_06](/blob/main/code/tutorials/tut08_06/tut08_06.zip?raw=true). 
...
1.	Open the program [tut08_07](/blob/main/code/tutorials/tut08_07/tut08_07.zip?raw=true). 
...
1.	Download the code in [tut08_08Processing](/blob/main/code/tutorials/tut08_08Processing/tut08_08Processing.zip?raw=true). 
...
1.	Download the code in [tut08_08jGrasp](/blob/main/code/tutorials/tut08_08jGrasp/tut08_08jGrasp.zip?raw=true). 
...
Using ``tut08_08Processing`` provide the necessary code to implement the ``Resizable`` interface shown in the [notes](/blob/main/notes/Interfaces.md)
